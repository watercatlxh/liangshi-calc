...
MasteryGs,
{
  ...
  sort: 9,
  data: {
    aPlus: ({ talent, calc, attr, params }) => calc(attr.hp) * talent.e['浪势充能伤害提升'] / 100 * (params.Wave_Momentum || 0),
...
},
{
  ...
  sort: 9,
  data: {
    aPlus: ({ calc, attr, params }) => (params.SkillsAfter || 2) < 2 ? (calc(attr.hp) * 66 / 100) : 0
  }
},
{
